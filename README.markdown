...
* Производить данную фильтрацию максимально прозрачно как для программиста модели, так и для верстальщика шаблона.
...
* Одни и те же структуры данны используются для вывода в множестве шаблонов;
