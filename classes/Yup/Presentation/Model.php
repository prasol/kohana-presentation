...
class Presentation_Model extends Presentation {
     ...
     * @var string
     */
    protected static $_sub_prefix = 'Model_';
    ...
    public static function factory($model = NULL)
    {
        ...
        if (is_string($model))
        {
            $class_name = NS::add_class_prefix($model, static::$_class_prefix . static::$_sub_prefix);
    ...
    {
        $class_name = NS::add_class_prefix($model, static::$_class_prefix);
        if (class_exists($class_name))
        {
            return $class_name;
        }
    ...
    {
        return NS::remove_class_prefix($this, static::$_class_prefix . static::$_sub_prefix);
    }
